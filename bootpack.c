...
void HariMain(void){
    ...
    *((int *)0x0fe4) = (int)shtctl;
    ...
    putfonts8_asc_sht(sht_back,mx-50,my,COL8_FFFFFF,COL8_008484,"Haribote OS",11);

    // 最初にキーボード状態との食い違いが内容、設定しておくことにする
...
void close_constask(struct TASK *task){
    struct MEMMEN *memman = (struct MEMMAN *)MEMMAN_ADDR;
    task_sleep(task);
