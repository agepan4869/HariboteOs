...
io_out8:        ; void io_to_in_out8(int port,int data);
    MOV     EDX,[ESP+4]         ; port
    MOV     AL,[ESP+8]          ; data
    OUT     DX,AL               ; 8
    RET

io_out16:       ; void io_to_in_out16(int port,int data);
    MOV     EDX,[ESP+4]         ; port
    MOV     EAX,[ESP+8]          ; data
    OUT     DX,AL               ; 16
    RET

io_out32:       ; void io_to_in_out32(int port,int data);
    MOV     EDX,[ESP+4]         ; port
    MOV     EAX,[ESP+8]          ; data
    OUT     DX,EAX               ; 32
    RET
